...
export const TOOL_NARRATIONS: Record<string, readonly string[]> = {
	...
	"git.push": ["Pushing that up now...", "Sending changes upstream...", "Pushing to the remote..."],
	"git.pull": [
	...
	"fs.write": ["Writing that out now...", "Saving changes...", "Putting that down on disk..."],
	"fs.list": [
		"Listing the directory contents...",
		"Let me see what's in there...",
		"Browsing the file system...",
	],
	"fs.delete": ["Removing that file...", "Deleting now...", "Taking care of that removal..."],
	"bash.exec": [
	...
	"gmail.read": ["Opening up that email...", "Let me read that...", "Pulling up the message..."],
	"gmail.send": ["Sending that off now...", "Firing off the email...", "Message away..."],
	"gmail.reply": [
		"Drafting the reply...",
...
export function getToolNarration(
	toolName: string,
	toolPickers: Map<string, NarrationPicker>,
	genericPicker: NarrationPicker,
): string {
