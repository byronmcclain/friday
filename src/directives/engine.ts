...
import type { Signal, SignalBus, SignalName } from "../core/events.ts";
import type { DirectiveStore } from "./store.ts";
import type { DirectiveAction, FridayDirective } from "./types.ts";
...
export class DirectiveEngine {
	...
	private async executeDirective(directive: FridayDirective, signal: Signal): Promise<void> {
